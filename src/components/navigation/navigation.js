...
export default function Navigation({ theme, toggleTheme, loggedIn }) {
                        ...
                        <div className="d-flex align-self-center me-3">
                            ...
                            <div className="navbar-nav dropdown">
                                ...
                                <ul className="dropdown-menu dropdown-menu-end dropdown-menu-gray" aria-labelledby="navbarDropdown">
                                    {!loggedIn && <li><a className="dropdown-item" href="/login">Log in</a></li>}
                                    {!loggedIn && <li><a className="dropdown-item" href="/register">Sign up</a></li>}
                                    {loggedIn && <li><a className="dropdown-item" href="/" onClick={logOut}>Log Out</a></li>}
                                    {loggedIn && <li><ToggleButton theme={theme} toggleTheme={toggleTheme} /></li>}
                                </ul>
                            </div>
                        </div>
                    </div>
