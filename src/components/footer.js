        ...
        <div className="footer bg-dark mvh-45 d-flex flex-column pt-md-5 align-items-center overflow-auto">
            <div className="d-flex flex-column flex-md-row w-100 justify-content-center">
                ...
                <div className="card border-0 w-md-15 bg-transparent">
                    <div className="card-body d-flex flex-column">
                        ...
                        <a href="/" className="text-decoration-none text-white-80 text-small">Investment Relations</a>
                        <a href="/" className="text-decoration-none text-white-80 text-small">Accessiblity</a>
                        <a href="/" className="text-decoration-none text-white-80 text-small"> Company Over</a>
                        <a href="/" className="text-decoration-none text-white-80 text-small">Stocks Plans</a>
                    </div>
                </div>
                <div className="card border-0 w-md-15 bg-transparent">
                    <div className="card-body d-flex flex-column">
                        <span className="card-title text-white text-uppercase mb-3">Portfolio</span>
                        <a href="/" className="text-decoration-none text-white-80 text-small mb-2">Financial and Application</a>
                        <a href="/" className="text-decoration-none text-white-80 text-small mb-2">Executive Services</a>
                ...
                <div className="card border-0 w-md-15 bg-transparent">
                    <div className="card-body d-flex flex-column">
                        ...
                        <a href="/" className="text-decoration-none text-white-80 text-small mb-2">Contact Us</a>
            ...
            <div className="d-flex w-md-75 ps-md-3 flex-column">
                <div className="d-flex">
                    ...
                    <a href="/" className="text-decoration-none text-white-80 text-small text-uppercase">Stocks</a>
                    <span className="text-decoration-none text-white-80 text-small mx-2">|</span>
            ...
            <div className="d-flex flex-column my-3">
                <span className="text-white-80">Copyright &copy; 2021 Stock Portfolio. All Rights Reserved</span>
                <div className="d-flex">
