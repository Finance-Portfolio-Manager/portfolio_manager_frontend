...
const wrapper = shallow(<FavoritesCard portfolio={portObj1} user={demoUser} setDisplayPortfolio={displayFn}></FavoritesCard>);

test("matches snapshot", ()=>{
    const tree = renderer.create(<FavoritesCard portfolio={portObj1} user={demoUser} setDisplayPortfolio={displayFn}></FavoritesCard>).toJSON();
