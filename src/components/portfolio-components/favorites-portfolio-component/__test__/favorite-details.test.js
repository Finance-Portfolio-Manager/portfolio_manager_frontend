...
const wrapper = shallow(<FavoritesDetails portfolio={portObj1} username="test_user" toggleShowDetails={toggleFn}></FavoritesDetails>);

test("matches snapshot", ()=>{
    const tree = renderer.create(<FavoritesDetails portfolio={portObj1} username="test_user" toggleShowDetails={toggleFn}></FavoritesDetails>).toJSON();
