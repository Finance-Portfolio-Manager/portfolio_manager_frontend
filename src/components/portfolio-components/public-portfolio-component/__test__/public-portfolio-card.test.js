...
let demoUser = [{name: "trent", username: "trent1234", email: "trgreenman88@gmail.com"}]

const displayFn = jest.fn(); 

configure({ adapter: new Adapter() });
// const wrapper = shallow(<PublicPortfolioCard portfolio={portObj1} user={demoUser} setDisplayPortfolio={displayFn}></PublicPortfolioCard>);

test("matches snapshot", ()=>{
    // const tree = renderer.create(<PublicPortfolioCard portfolio={portObj1} user={demoUser} setDisplayPortfolio={displayFn}></PublicPortfolioCard>).toJSON();
